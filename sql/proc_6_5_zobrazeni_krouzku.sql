CREATE OR ALTER PROCEDURE PROC_6_5_ZOBRAZENI_KROUZKU(@P_DATUMOD DATE, @P_DATUMDO DATE, @P_AKTUALNIDATUM DATE)
AS
BEGIN
                        ...
                        BEGIN
                            ...
                            ELSE
                                BEGIN
                                    ...
                                    INSERT @V_RET_TABLE
                                    VALUES (@V_KROUZEK_IDKROUZEK, @V_KALENDAR_DATUM, @V_KROUZEK_IDKONKRETNIKROUZEK, 1);
