CREATE OR ALTER PROCEDURE PROJEKT.PROC_3_5_VYPOCET_HODIN_OBDOBI(@P_OBDOBIOD DATE,
                                                                @P_OBDOBIDO DATE,
                                                                @P_IDOSOBA INTEGER,
    ...
    BEGIN TRY
        ...
        DECLARE C_CURS CURSOR LOCAL FOR SELECT CASKONANIOD,
                                        ...
                                        WHERE VYUCUJICIKROUZEK.IDLEKTOR = @P_IDOSOBA
                                          AND KONKRETNIKROUZEK.DATUM >= @P_OBDOBIOD
                                          AND KONKRETNIKROUZEK.DATUM <= @P_OBDOBIDO;
