CREATE OR ALTER PROCEDURE PROC_9_4_ZVYSENI_MZDY_LEKTOROVI(@P_IDLEKTOR INTEGER, @P_PLATNOSTOD DATE)
AS
BEGIN
    ...
    EXEC PROC_3_6_VYPOCET_HODIN_CELKEM @P_IDLEKTOR, @V_HODINCELKEM OUTPUT;
    ...
    VALUES (@P_IDLEKTOR, @V_OLD_HODINOVAMZDA_MZDA + @V_HODNOTAZVYSENI, DATEADD(DAY, 1, @V_OLD_HODINOVAMZDA_PLATNOSTOD));
    PRINT 'Mzda zvysena'
END
GO
