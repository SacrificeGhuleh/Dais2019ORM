namespace Krouzky.ORM.Database.DTO
{
    ...
    public class Skola : Connectable
    {
        ...
        public Skola(int idSkola, int idAdresa)
        {
            ...
            if (instances == null)
            {
                instances = new Dictionary<int, Skola>();
            }
        ...
        {
            if (Adresa.instances != null)
            {
                this.adresa = Adresa.instances[this.idAdresa];
            }
        }

        public override string ToString() => "<Skola> idSkola: " + this.idSkola + " |idAdresa: " + this.idAdresa;
    }
}